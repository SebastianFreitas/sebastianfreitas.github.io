...
window.Gen = (function () {
  ...
  G.BEATS = [
    ...
    { id: "dress", dur: 7.0, tag: "XI · Borrowed shape",
      line: "Binding it, they learned from it. They took our shape as far as they could bear it, and covered what they could not change." },
    { id: "worlds", dur: 8.5, tag: "XII · The made worlds",
      line: "Inside the womb they made places for us, by hand, one law at a time. Nothing in them answered to belief." },
    { id: "remake", dur: 7.5, tag: "XIII · Taken apart",
      line: "We had been eating one another since before there was a before. They pulled us apart, kept what would hold, and made us again." },
    { id: "lives", dur: 9.0, tag: "XIV · Again",
      line: "We lived, and forgot, and were sent to live again, more times than anyone counted. Then two of us remembered what no one had taught." },
    { id: "leave", dur: 6.5, tag: "XV · The hands",
      line: "And the hands were gone. The worlds went on turning, and nothing watched them any more." },
    { id: "birth", dur: 6.2, tag: "XVI · First born",
      line: "Two lights tore out of the womb. Obrokxus, wrong from his first breath. And Rex, burning like a new star." },
    { id: "fight", dur: 8.2, tag: "XVII · Obrokxus · Rex",
      line:"They met in the void, and the void shook to its roots. We are told that Rex broke. We are not told how." },
    { id: "land",  dur: 6.6, tag: "XVIII · Rex the surface",
      line: "With the last of himself Rex closed about Obrokxus, and fell. His body cooled into ground, and the ground held." },
    { id: "gods", dur: 7.0, tag: "XIX · The others",
    ...
    { id: "deep", dur: 11.0, tag: "XX · Inside Rex",
    ...
    { id: "aelius", dur: 8.6, tag: "XXVII · Aelius Luxent",
    ...
    { id: "velindra", dur: 11.0, tag: "XXVIII · Velindra",
