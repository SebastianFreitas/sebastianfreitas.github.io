...
window.Gen = (function () {
  ...
  G.BEATS = [
    ...
    { id: "enter", dur: 5.0, tag: "IX · Inward",
      line: "Beside the bridge hung a ball of flesh, the Primordisentia's womb. Inside, nothing had a shape yet." },
    { id: "soup", dur: 7.0, tag: "X · The soup",
      line: "Within it churned a soup of red and blue, and the red fed on the blue." },
    { id: "eye", dur: 7.0, tag: "XI · The eye",
      line: "Something older opened an eye. Everything it looked at fell to dust, and the colour ran out of the dust." },
    { id: "roles", dur: 8.0, tag: "XII · The roles",
      line: "The old ones came to watch. They took roles as enforcers, watchers, mothers and messengers, and changed their bodies to fit." },
    { id: "circle", dur: 7.5, tag: "XIII · The first universe",
      line: "One of them drew a circle. The dust was pulled in, and one thread of colour with it: the first universe, with little feeling and no magic." },
    { id: "chains", dur: 8.0, tag: "XIV · Chains",
      line: "Each universe gave birth to the next, linked like rings of chain mail, until there were billions. The later ones carried magic." },
    { id: "corrupt", dur: 6.5, tag: "XV · Corruption",
      line: "Some rings turned red. The old ones cut them out and returned them to the soup. The red that would not come out was sent up, and it built." },
    { id: "rex", dur: 7.5, tag: "XVI · Rex Immotus",
      line: "Rex Immotus came into being so vast that he tore his universe apart and kept growing past many more, until the chains settled round him like rivers." },
    { id: "dot", dur: 5.5, tag: "XVII · The red dot",
      line: "A red dot slipped out of a corrupted universe: Obrokxus, in his first form. Rex moved to stop him." },
    { id: "clash", dur: 6.5, tag: "XVIII · The walls",
      line: "They met at the wall of the womb, body and soul against the chaos of the void." },
    { id: "death", dur: 6.0, tag: "XIX · The fist",
      line: "Rex died before he was fully out, his fist closed over Obrokxus against the void." },
    { id: "gods", dur: 7.0, tag: "XX · Through him",
      line: "The gods were not born into the void. They passed through Rex, who had become the land and the bridge between the womb and the world. Every newborn soul carries a piece of him." },
    { id: "calm", dur: 5.5, tag: "XXI · The womb",
      line: "Outside, the womb floated quiet again." },
    { id: "deep", dur: 11.0, tag: "XXII · Inside Rex",
    ...
    { id: "aelius", dur: 8.6, tag: "XXIX · Aelius Luxent",
    ...
    { id: "velindra", dur: 11.0, tag: "XXX · Velindra",
  ...
  (function () {
    ...
    G.BEAT_START[G.BEATS.length] = acc;
  })();
  ...
  G.idxOf = function (id) {
    ...
    return i == null ? G.BEATS.length : i;
  };
  G.since = function (id) {
    const i = G.idxOf(id);
